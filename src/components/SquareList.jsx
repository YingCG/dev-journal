...
function SquareList() {
  ...
  const afternoonPallete = ['#88E0EF', '#FFADAD', '#FFE162', '#E7E9EB', '#FFB085', '#F2FFE9', '#CDF2CA', '#FFFDE8', '#E6DDC6', '#FDFFBC', '#F5C6AA']
  ...
  return (
    <>
      ...
      <div className='square-list'>
        ...
        <div className='square' style={{ backgroundColor: colors[10] }} onClick={changeOneColour}>
          <Square key={7} colors={colors}
            info={{ title: "React State ", links: [], description: "State is used with React Component Classes to make them dynamic. You can  change the colour pallete of this page by clicking this button or clicking individual square color to change colour." }} updateColor={changeOneColour} />
          <button className='pallete-btn' onClick={changeColourPallete}><a>Change colour pallete</a></button>
        </div>
